...
const initialData = {
  heroTitle: "Galeri Kegiatan",
  heroSubtitle: "Jejak langkah nyata kami tergambar dalam momen-momen kebersamaan, perjuangan, dan senyum bahagia mereka yang terbantu."
};
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="mb-8">
        ...
        <p className="text-body mt-1">Ubah konten pengantar pada halaman Galeri.</p>
      </div>
